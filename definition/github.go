...
func Github(opts ...EmojisOption) Emojis {
	githubOnce.Do(func() {
		github = NewEmojis(
			...
			NewEmoji("grinning squinting face", []int32{128518}, "satisfied"),
			...
			NewEmoji("pouting face", []int32{128545}, "pout"),
			...
			NewEmoji("pile of poo", []int32{128169}, "poop"),
			NewEmoji("pile of poo", []int32{128169}, "shit"),
			...
			NewEmoji("collision", []int32{128165}, "collision"),
			...
			NewEmoji("raised hand", []int32{9995}, "raised_hand"),
			...
			NewEmoji("middle finger", []int32{128405}, "fu"),
			...
			NewEmoji("thumbs up", []int32{128077}, "thumbsup"),
			NewEmoji("thumbs down", []int32{128078}, "-1"),
			NewEmoji("thumbs down", []int32{128078}, "thumbsdown"),
			NewEmoji("raised fist", []int32{9994}, "fist_raised"),
			NewEmoji("raised fist", []int32{9994}, "fist"),
			NewEmoji("oncoming fist", []int32{128074}, "fist_oncoming"),
			NewEmoji("oncoming fist", []int32{128074}, "facepunch"),
			NewEmoji("oncoming fist", []int32{128074}, "punch"),
			...
			NewEmoji("woman: blond hair", []int32{128113, 8205, 9792, 65039}, "blonde_woman"),
			...
			NewEmoji("man gesturing NO", []int32{128581, 8205, 9794, 65039}, "ng_man"),
			NewEmoji("woman gesturing NO", []int32{128581, 8205, 9792, 65039}, "no_good_woman"),
			NewEmoji("woman gesturing NO", []int32{128581, 8205, 9792, 65039}, "ng_woman"),
			...
			NewEmoji("person tipping hand", []int32{128129}, "information_desk_person"),
			NewEmoji("man tipping hand", []int32{128129, 8205, 9794, 65039}, "tipping_hand_man"),
			NewEmoji("man tipping hand", []int32{128129, 8205, 9794, 65039}, "sassy_man"),
			NewEmoji("woman tipping hand", []int32{128129, 8205, 9792, 65039}, "tipping_hand_woman"),
			NewEmoji("woman tipping hand", []int32{128129, 8205, 9792, 65039}, "sassy_woman"),
			...
			NewEmoji("police officer", []int32{128110}, "cop"),
			...
			NewEmoji("person running", []int32{127939}, "running"),
			...
			NewEmoji("woman dancing", []int32{128131}, "dancer"),
			...
			NewEmoji("man bouncing ball", []int32{9977, 65039, 8205, 9794, 65039}, "basketball_man"),
			NewEmoji("woman bouncing ball", []int32{9977, 65039, 8205, 9792, 65039}, "bouncing_ball_woman"),
			NewEmoji("woman bouncing ball", []int32{9977, 65039, 8205, 9792, 65039}, "basketball_woman"),
			...
			NewEmoji("paw prints", []int32{128062}, "paw_prints"),
			...
			NewEmoji("dolphin", []int32{128044}, "flipper"),
			...
			NewEmoji("honeybee", []int32{128029}, "honeybee"),
			...
			NewEmoji("tangerine", []int32{127818}, "orange"),
			NewEmoji("tangerine", []int32{127818}, "mandarin"),
			...
			NewEmoji("kitchen knife", []int32{128298}, "knife"),
			...
			NewEmoji("automobile", []int32{128663}, "red_car"),
			...
			NewEmoji("sailboat", []int32{9973}, "sailboat"),
			...
			NewEmoji("waxing gibbous moon", []int32{127764}, "waxing_gibbous_moon"),
			...
			NewEmoji("t-shirt", []int32{128085}, "tshirt"),
			...
			NewEmoji("man’s shoe", []int32{128094}, "shoe"),
			...
			NewEmoji("telephone", []int32{9742, 65039}, "telephone"),
			...
			NewEmoji("red paper lantern", []int32{127982}, "lantern"),
			...
			NewEmoji("open book", []int32{128214}, "open_book"),
			...
			NewEmoji("e-mail", []int32{128231}, "email"),
			...
			NewEmoji("memo", []int32{128221}, "pencil"),
			...
			NewEmoji("exclamation mark", []int32{10071}, "heavy_exclamation_mark"),
			...
			NewEmoji("flag: European Union", []int32{127466, 127482}, "european_union"),
			...
			NewEmoji("flag: United Kingdom", []int32{127468, 127463}, "uk"),
