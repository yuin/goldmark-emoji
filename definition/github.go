...
func Github(opts ...EmojisOption) Emojis {
	githubOnce.Do(func() {
		github = NewEmojis(
			...
			NewEmoji("melting face", []int32{129760}, "melting_face"),
			...
			NewEmoji("face with open eyes and hand over mouth", []int32{129762}, "face_with_open_eyes_and_hand_over_mouth"),
			NewEmoji("face with peeking eye", []int32{129763}, "face_with_peeking_eye"),
			NewEmoji("shushing face", []int32{129323}, "shushing_face"),
			NewEmoji("thinking face", []int32{129300}, "thinking"),
			NewEmoji("saluting face", []int32{129761}, "saluting_face"),
			...
			NewEmoji("dotted line face", []int32{129765}, "dotted_line_face"),
			...
			NewEmoji("shaking face", []int32{129768}, "shaking_face"),
			...
			NewEmoji("face with diagonal mouth", []int32{129764}, "face_with_diagonal_mouth"),
			...
			NewEmoji("face holding back tears", []int32{129401}, "face_holding_back_tears"),
			...
			NewEmoji("enraged face", []int32{128545}, "rage", "pout"),
			...
			NewEmoji("pink heart", []int32{129655}, "pink_heart"),
			...
			NewEmoji("light blue heart", []int32{129653}, "light_blue_heart"),
			...
			NewEmoji("grey heart", []int32{129654}, "grey_heart"),
			...
			NewEmoji("rightwards hand", []int32{129777}, "rightwards_hand"),
			NewEmoji("leftwards hand", []int32{129778}, "leftwards_hand"),
			NewEmoji("palm down hand", []int32{129779}, "palm_down_hand"),
			NewEmoji("palm up hand", []int32{129780}, "palm_up_hand"),
			NewEmoji("leftwards pushing hand", []int32{129783}, "leftwards_pushing_hand"),
			NewEmoji("rightwards pushing hand", []int32{129784}, "rightwards_pushing_hand"),
			...
			NewEmoji("hand with index finger and thumb crossed", []int32{129776}, "hand_with_index_finger_and_thumb_crossed"),
			...
			NewEmoji("index pointing at the viewer", []int32{129781}, "index_pointing_at_the_viewer"),
			...
			NewEmoji("heart hands", []int32{129782}, "heart_hands"),
			...
			NewEmoji("biting lip", []int32{129766}, "biting_lip"),
			...
			NewEmoji("person with crown", []int32{129733}, "person_with_crown"),
			...
			NewEmoji("pregnant man", []int32{129731}, "pregnant_man"),
			NewEmoji("pregnant person", []int32{129732}, "pregnant_person"),
			...
			NewEmoji("troll", []int32{129484}, "troll"),
			...
			NewEmoji("moose", []int32{129742}, "moose"),
			NewEmoji("donkey", []int32{129743}, "donkey"),
			...
			NewEmoji("wing", []int32{129725}, "wing"),
			NewEmoji("black bird", []int32{128038, 8205, 11035}, "black_bird"),
			NewEmoji("goose", []int32{129727}, "goose"),
			...
			NewEmoji("coral", []int32{129720}, "coral"),
			NewEmoji("jellyfish", []int32{129724}, "jellyfish"),
			...
			NewEmoji("lotus", []int32{129719}, "lotus"),
			...
			NewEmoji("hyacinth", []int32{129723}, "hyacinth"),
			...
			NewEmoji("empty nest", []int32{129721}, "empty_nest"),
			NewEmoji("nest with eggs", []int32{129722}, "nest_with_eggs"),
			...
			NewEmoji("beans", []int32{129752}, "beans"),
			NewEmoji("chestnut", []int32{127792}, "chestnut"),
			NewEmoji("ginger root", []int32{129754}, "ginger_root"),
			NewEmoji("pea pod", []int32{129755}, "pea_pod"),
			...
			NewEmoji("pouring liquid", []int32{129751}, "pouring_liquid"),
			...
			NewEmoji("playground slide", []int32{128733}, "playground_slide"),
			...
			NewEmoji("wheel", []int32{128734}, "wheel"),
			...
			NewEmoji("ring buoy", []int32{128735}, "ring_buoy"),
			...
			NewEmoji("mirror ball", []int32{129705}, "mirror_ball"),
			...
			NewEmoji("folding hand fan", []int32{129709}, "folding_hand_fan"),
			...
			NewEmoji("hair pick", []int32{129710}, "hair_pick"),
			...
			NewEmoji("maracas", []int32{129671}, "maracas"),
			NewEmoji("flute", []int32{129672}, "flute"),
			...
			NewEmoji("low battery", []int32{129707}, "low_battery"),
			...
			NewEmoji("crutch", []int32{129660}, "crutch"),
			NewEmoji("stethoscope", []int32{129658}, "stethoscope"),
			NewEmoji("x-ray", []int32{129659}, "x_ray"),
			...
			NewEmoji("bubbles", []int32{129767}, "bubbles"),
			...
			NewEmoji("hamsa", []int32{129708}, "hamsa"),
			NewEmoji("moai", []int32{128511}, "moyai"),
			NewEmoji("placard", []int32{129703}, "placard"),
			NewEmoji("identification card", []int32{129706}, "identification_card"),
			...
			NewEmoji("khanda", []int32{129711}, "khanda"),
			...
			NewEmoji("wireless", []int32{128732}, "wireless"),
			...
			NewEmoji("heavy equals sign", []int32{129008}, "heavy_equals_sign"),
